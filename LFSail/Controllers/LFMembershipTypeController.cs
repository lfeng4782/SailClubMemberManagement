...
{
    public class LFMembershipTypeController : Controller
    {
        private readonly SailContext _context;

        public LFMembershipTypeController(SailContext context)
        {
            _context = context;
        }

        // GET: LFMembershipType
        public async Task<IActionResult> Index()
        {
            return View(await _context.MembershipType.ToListAsync());
        }

        // GET: LFMembershipType/Details/5
        ...
        // GET: LFMembershipType/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: LFMembershipType/Create
        ...
        // POST: LFMembershipType/Delete/5
