...
{
    public class LFParkingController : Controller
    {
        private readonly SailContext _context;

        public LFParkingController(SailContext context)
        {
            _context = context;
        }
        ...
        {
            var parking =await _context.Parking.OrderBy(x=>x.ParkingCode).Include(p => p.BoatType).ToListAsync();
            return View(parking);
        }
